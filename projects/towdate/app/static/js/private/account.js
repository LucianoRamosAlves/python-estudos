...
function initProfilePhotoChange() {
    ...
    const input = byId("fotoPerfil");
    const button = byId("btnAlterarFoto");
...
function initRelationshipPhotoChange() {
    const form = byId("relationshipPhotoForm");
    const input = byId("couplePhoto");
    const button = byId("btnAlterarFotoRelacionamento");
